...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    S(KC_F5),KC_F5,   KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL, \
    KC_F11,  KC_F12,  KC_F13,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_PGUP, \
  ...
  [_LOC] = LAYOUT_65_with_macro(
    ...
    KC_F11,  KC_F12,  KC_F13,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_PGUP, \
    KC_F14,  KC_F15,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN, \
    KC_F11,  KC_F10,  KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,           XXXXXXX, KC_SPC,  XXXXXXX, TD(DISC),MO(_FN2),KC_LEFT, KC_DOWN, KC_RGHT
  ),
